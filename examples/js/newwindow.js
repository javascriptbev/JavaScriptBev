function alertWin(title, msg, w, h) {
    ...
    titleBar.style.cssText = "width:100%;zindex:1;height:" + titleheight + "px;text-align:left;padding:3px;margin:0px;font:bold 13px '宋体';color:" + titlecolor + ";border:1px solid " + bordercolor + ";cursor:move;background-color:" + titlebgcolor;
